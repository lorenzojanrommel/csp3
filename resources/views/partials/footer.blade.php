...
<footer class="page-footer font-small stylish-color-dark pt-4 mt-5">
    ...
    <div class="container text-center text-md-left">
        <div class="row">
            ...
            <!--First column-->
            <div class="col-md-4">
                <h5 class="text-uppercase mb-4 mt-3 font-weight-bold wow fadeInLeft" data-wow-delay="0.3s">Gaming Blog</h5>
                <p class="wow fadeIn" data-wow-delay="0.2s">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
            ...
            <!--Second column-->
            <div class="col-md-2 mx-auto wow fadeInUp" data-wow-delay="0.3s">
            ...
            <!--Third column-->
            <div class="col-md-2 mx-auto wow fadeInUp" data-wow-delay="0.4s">
                <h5 class="text-uppercase mb-4 mt-3 font-weight-bold">Links</h5>
                <ul class="list-unstyled">
                    <li><a href="#!">Link 1</a></li>
                    <li><a href="#!">Link 2</a></li>
            ...
            <!--Fourth column-->
            <div class="col-md-2 mx-auto wow fadeInUp" data-wow-delay="0.5s">
                <h5 class="text-uppercase mb-4 mt-3 font-weight-bold ">Links</h5>
                <ul class="list-unstyled">
                    <li><a href="#!">Link 1</a></li>
                    <li><a href="#!">Link 2</a></li>
    ...
    <div class="footer-copyright py-3 text-center">
        <div class="container-fluid">
            © 2018 Copyright || Capstone 3 || Jan Rommel Lorenzo
